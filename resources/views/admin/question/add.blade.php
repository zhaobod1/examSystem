        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    ...
                    <script id="editor" name="question_content" type="text/plain" style="width:860px;height:500px;"></script>
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="question_answer" placeholder="只允许数字">
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i> 分值：</th>
                <td>
                    <input type="text" class="sm" name="question_score" placeholder="只允许数字">
                </td>
            </tr>
            <tr>
                <th><i class="require">*</i> 是否加入题库：</th>
                <td>
                    <input type="text" class="lg" name="question_is_quest_bank" placeholder="填写'1', 代表入库,填写'0'或者留空,代表不入库">
                </td>
            </tr>
